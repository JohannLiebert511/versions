...
Requires(post): kernel = 4.14.0-2%{?extraver}.git68b4afb%{dist}
...
Requires(post): libvirt = 3.9.0-1%{?extraver}.gitcb3885f%{dist}
...
%changelog
* Fri Dec 29 2017 JohannLiebert511 <johannliebert1975@gmail.com> - 3.5-4.dev
