...
Requires(post): kernel = 4.15.0-1%{?extraver}.gita707e6c%{dist}
...
Requires(post): libvirt = 4.0.0-1%{?extraver}.git5e6f8a1%{dist}
Requires(post): qemu = 15:2.11.50-1%{?extraver}.git59cc362%{dist}
...
%changelog
* Fri Feb 09 2018 JohannLiebert511 <johannliebert1975@gmail.com> - 3.5-4.dev
