...
Requires(post): kernel = 4.16.0-1%{?extraver}.gitb24758c%{dist}
...
Requires(post): SLOF = 20171214-1%{?extraver}.gitc2a331f%{dist}
...
%changelog
* Thu Apr 19 2018 JohannLiebert511 <johannliebert1975@gmail.com> - 3.5-4.dev
